...
- Do not broaden the proved claim. The current result concerns the authors'
  released ApproxKelly initialization, intersected with the logical confidence
  sequence, for the expected stopping-time objective stated in this repository.
